...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  hero: {
    ...
    image: "https://picsum.photos/seed/aley-mountain-town/1920/1080",
  ...
  sections: {
    ...
    gems: {
      ...
      items: [
        { title: "Quiet cafés to study", sub: "Wi-Fi, plugs & calm corners", to: "/explore?category=coffee-shops", img: "https://picsum.photos/seed/gem-study/600/450" },
        { title: "Best breakfast spots", sub: "Start your morning right", to: "/explore?q=breakfast", img: "https://picsum.photos/seed/gem-breakfast/600/450" },
        { title: "Family-friendly places", sub: "Fun for everyone", to: "/explore?q=family", img: "https://picsum.photos/seed/gem-family/600/450" },
        { title: "Sunset views", sub: "Golden hour over the mountains", to: "/explore?q=view", img: "https://picsum.photos/seed/gem-sunset/600/450" },
        { title: "Local favorites", sub: "Most-loved by Aley", to: "/explore?sort=reviews", img: "https://picsum.photos/seed/gem-favorites/600/450" },
        { title: "Late-night eats", sub: "Open when you need them", to: "/explore?openNow=true&category=restaurants", img: "https://picsum.photos/seed/gem-latenight/600/450" },
      ],
    },
  ...
  about: {
    ...
    image: "https://picsum.photos/seed/aley-streets/1600/700",
  },
  loveAley: {
    title: "Love Aley ❤",
    ...
    image: "https://picsum.photos/seed/aley-nature/1600/700",
  },
};
